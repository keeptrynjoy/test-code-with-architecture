...
class UserControllerTest {
    ...
    @Test
    void 사용자는_특정_유저의_정보에서_개인정보를_소거된채_전달_받을_수_있다(){
        // given
    ...
    void 사용자는_인증_코드로_계정을_활성화_시킬_수_있다(){
        ...
        // when
        ResponseEntity<Void> result = testContainer.userController.verifyEmail(1, "aaaaaaa-aaaaaa-aaaaa-aaaaaaaaa");
    ...
    void 사용자는_인증_코드가_일치하지_않을_경우_권한_없음_에러를_내려준다(){
        ...
        // when & then
        assertThatThrownBy(()->{
            testContainer.userController.verifyEmail(1, "aaaaaaa-aaaaaa-aaaaa-aaaaaaaab");
    ...
    void 사용자는_내_정보를_불러올_때_개인정보인_주소도_갖고_올_수_있다(){
        ...
        ResponseEntity<MyProfileResponse> result = testContainer.userController
                .getMyInfo("sungmin4218@gmail.com");
    ...
    void 사용자는_내_정보를_수정할_수_있다(){
        ...
        // when
        ResponseEntity<MyProfileResponse> result = testContainer.userController
                .updateMyInfo("sungmin4218@gmail.com", UserUpdate.builder()
                        .address("Busan")
        ...
        assertThat(result.getBody()).isNotNull();
        assertThat(result.getBody().getEmail()).isEqualTo("sungmin4218@gmail.com");
        assertThat(result.getBody().getNickname()).isEqualTo("code300jade");
        assertThat(result.getBody().getLastLoginAt()).isEqualTo(100);
